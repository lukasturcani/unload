...
#[component]
fn MegaMenuLink(label: ReadOnlySignal<String>) -> Element {
    rsx! {
        a {
            href: "#",
...
#[component]
fn NavLink(label: ReadOnlySignal<String>) -> Element {
    rsx! {
        a {
            href: "#",
...
#[component]
fn SelectedNavLink(label: ReadOnlySignal<String>) -> Element {
    rsx! {
        a {
            href: "#",
