...
pub const KO: Translation<&'static str> = Translation {
    ...
    text: Text {
        ...
        unarchive_task_button_tooltip: "작업 복구",
        ...
        due_date_section_label: "기한",
        edit_due_date_tooltip: "기한 편집",
        due_date_form_label: "기한 설정",
        due_date_input_label: "기한",
        set_due_date_button_label: "기한 설정",
        cancel_due_date_update_button_label: "기한 업데이트 취소",
        ...
        chat_gpt_limit_exceeded_content: "ChatGPT 호출 한도에 도달했습니다. 나중에 다시 시도하십시오.",
        chat_gpt_waiting_message: "ChatGPT와 대화 중...",
        chat_gpt_error_title: "ChatGPT 오류",
        chat_gpt_error_content: "Chat GPT에 연결하는 동안 오류가 발생했습니다. 나중에 다시 시도하십시오.",
        chat_gpt_prompt_input_title: "ChatGPT 프롬프트",
        chat_gpt_daily_attempts_left: "일일 시도 횟수 남음",
        chat_gpt_prompt_input_content: "또는 아래 제안 중에서 선택하십시오:",
        ...
        friends_over_for_bbq_prompt: "바베큐에 친구 초대",
        prepare_for_rome_vacation_prompt: "로마 휴가 준비",
        house_tidy_prompt: "집 정돈",
        ...
        toggle_actions_drawer_button_label: "액션 서랍 전환",
