...
pub const SV: Translation<&'static str> = Translation {
    ...
    text: Text {
        ...
        toggle_show_themes_tooltip: "Ändra Tema",
        toggle_dense_view_tooltip: "Växla Kompakt Vy",
        edit_board_title_tooltip: "Redigera Titel",
        board_title_input_label: "Titel",
        board_title_update_form_label: "Uppdatera Styrelsetitel",
        ...
        task_title_update_form_label: "Uppdatera Uppgiftstitel",
        set_task_title_button_label: "Sätt Titel",
        cancel_task_title_update_button_label: "Avbryt Titeluppdatering",
        set_task_status_section_label: "Sätt Uppgiftsstatus",
        ...
        assignee_selection_section_label: "Tilldelningsval",
        ...
        tag_selection_section_label: "Taggval",
        ...
        cancel_description_update_button_label: "avbryt beskrivningsuppdatering",
        bullet_points_button_tooltip: "Punktlista",
        ...
        delete_task_tooltip: "Ta Bort Uppgift",
        ...
        cancel_tag_name_update_button_label: "Avbryt Namnuppdatering",
        delete_tag_button_label: "Ta Bort Tagg",
        ...
        cancel_user_name_update_button_label: "Avbryt Namnuppdatering",
        edit_user_name_button_label: "Redigera Namn",
        delete_user_button_label: "Ta Bort Användare",
        task_status_section_label: "Uppgiftsstatus",
        filters_section_label: "Filter",
        languages_section_title: "Språk",
        custom_task_button_label: "Anpassad Uppgift",
        board_list_section_label: "Styrelselista",
        join_board_button_label: "Gå Med i Styrelsen",
        ...
        suggest_cupcake_recipe_prompt: "föreslå cupcake-recept",
        paint_bedroom_prompt: "måla sovrummet",
        friends_over_for_bbq_prompt: "vänner över för BBQ",
        prepare_for_rome_vacation_prompt: "förbered för Rom-semester",
        house_tidy_prompt: "städa huset",
        fix_fence_prompt: "fixa staketet",
        join_board_form_label: "Gå Med i Styrelsen",
        join_board_input_label: "Styrelsenamn",
        cancel_joining_board_button_label: "Avbryt Styrelseinträde",
        add_task_button_label: "Lägg Till Uppgift",
        remove_board_button_label: "Ta Bort Styrelse",
        new_task_form_label: "Ny Uppgift",
        cancel_adding_new_task_button_label: "Avbryt Ny Uppgift",
        navigation_section_label: "Navigering",
        toggle_actions_drawer_button_label: "Växla Åtgärdslåda",
