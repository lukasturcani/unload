...
pub const CS: Translation<&'static str> = Translation {
    ...
    name: "CS - Czech",
    text: Text {
        to_do_column_title: "K Vyřízení",
        in_progress_column_title: "V Průběhu",
        done_column_title: "Hotovo",
        pick_language_tooltip: "Vybrat jazyk",
        toggle_show_themes_tooltip: "Změnit téma",
        toggle_dense_view_tooltip: "Přepnout zhuštěné zobrazení",
        edit_board_title_tooltip: "Upravit název",
        board_title_input_label: "Název",
        board_title_update_form_label: "Aktualizovat název nástěnky",
        ...
        to_do_button_tooltip: "K Vyřízení",
        in_progress_button_tooltip: "V Průběhu",
        ...
        delete_task_tooltip: "Smazat úkol",
        ...
        delete_tag_button_label: "Smazat štítek",
        ...
        delete_user_button_label: "Smazat uživatele",
        ...
        board_list_section_label: "Seznam nástěnek",
        join_board_button_label: "Připojit se k nástěnce",
        create_new_board_button_label: "Vytvořit novou nástěnku",
        or_label: "nebo",
        ...
        chat_gpt_prompt_input_title: "Výzva pro ChatGPT",
        chat_gpt_daily_attempts_left: "zbývající denní pokusy",
        chat_gpt_prompt_input_content: "nebo vyberte jednu z níže uvedených návrhů:",
        chat_gpt_prompt_input_form_label: "výzva pro chat gpt",
        ...
        join_board_form_label: "Připojit se k nástěnce",
        join_board_input_label: "Název nástěnky",
        cancel_joining_board_button_label: "Zrušit připojení k nástěnce",
        add_task_button_label: "Přidat úkol",
        remove_board_button_label: "Odstranit nástěnku",
