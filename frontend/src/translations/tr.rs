...
pub const TR: Translation<&'static str> = Translation {
    ...
    text: Text {
        ...
        in_progress_column_title: "Devam Edenler",
        done_column_title: "Tamamlananlar",
        pick_language_tooltip: "Dil Seç",
        toggle_show_themes_tooltip: "Temayı Değiştir",
        toggle_dense_view_tooltip: "Yoğun Görünümü Değiştir",
        ...
        cancel_board_title_update_button_label: "Başlık Güncellemeyi İptal Et",
        ...
        cancel_task_title_update_button_label: "Başlık Güncellemeyi İptal Et",
        set_task_status_section_label: "Görev Durumunu Ayarla",
        to_do_button_tooltip: "Yapılacaklar",
        in_progress_button_tooltip: "Devam Edenler",
        done_button_tooltip: "Tamamlananlar",
        ...
        assignees_section_label: "Atananlar",
        assign_user_toggle_button_tooltip: "Kullanıcı Ata",
        toggle_user_filter_button_label: "kullanıcı filtresini değiştir",
        assignee_selection_section_label: "atanacak kullanıcı seçimi",
        add_user_button_label: "Kullanıcı Ekle",
        add_user_form_label: "Kullanıcı Ekle",
        user_name_input_label: "Ad",
        ...
        tag_name_input_label: "Ad",
        add_tag_toggle_button_tooltip: "Etiket Ekle",
        cancel_adding_new_tag_button_label: "etiket eklemeyi iptal et",
        toggle_tag_filter_button_label: "etiket filtresini değiştir",
        remove_tag_from_task_button_label: "görevden etiketi çıkar",
        toggle_expand_task_button_label: "görevi genişlet",
        due_date_section_label: "son tarih",
        edit_due_date_tooltip: "Son Tarihi Düzenle",
        due_date_form_label: "son tarihi belirle",
        due_date_input_label: "Son Tarih",
        set_due_date_button_label: "son tarihi ayarla",
        cancel_due_date_update_button_label: "son tarih güncellemeyi iptal et",
        ...
        cancel_description_update_button_label: "açıklama güncellemeyi iptal et",
        ...
        cancel_tag_color_update_label: "Renk Güncellemeyi İptal Et",
        edit_tag_name_button_label: "Adı Düzenle",
        edit_tag_name_form_label: "Adı Düzenle",
        set_tag_name_button_label: "Adı Ayarla",
        cancel_tag_name_update_button_label: "Ad Güncellemeyi İptal Et",
        delete_tag_button_label: "Etiketi Sil",
        archive_tag_button_label: "Etiketi Arşivle",
        unarchive_tag_button_label: "Etiketi Geri Yükle",
        edit_user_color_form_label: "Rengi Düzenle",
        set_user_color_button_label: "Rengi Ayarla",
        cancel_user_color_update_button_label: "Renk Güncellemeyi İptal Et",
        edit_user_color_button_label: "Rengi Düzenle",
        edit_user_name_form_label: "Adı Düzenle",
        set_user_name_button_label: "Adı Ayarla",
        cancel_user_name_update_button_label: "Ad Güncellemeyi İptal Et",
        edit_user_name_button_label: "Adı Düzenle",
        ...
        chat_gpt_limit_exceeded_content: "ChatGPT çağrıları limitine ulaştınız. Lütfen daha sonra tekrar deneyin.",
        chat_gpt_waiting_message: "ChatGPT ile konuşuluyor...",
        chat_gpt_error_title: "ChatGPT Hatası",
        chat_gpt_error_content: "Chat GPT ile bağlantı kurulmaya çalışılırken bir hata oluştu. Lütfen daha sonra tekrar deneyin.",
        chat_gpt_prompt_input_title: "ChatGPT Girdisi",
        chat_gpt_daily_attempts_left: "günlük deneme sayısı kaldı",
        chat_gpt_prompt_input_content: "veya aşağıdaki önerilerden birini seçin:",
        chat_gpt_prompt_input_form_label: "chat gpt girdi",
        chat_gpt_prompt_input_label: "Girdi:",
        suggest_cupcake_recipe_prompt: "cupcake tarifi öner",
        paint_bedroom_prompt: "yatak odasını boya",
        friends_over_for_bbq_prompt: "barbekü için arkadaşları davet et",
        prepare_for_rome_vacation_prompt: "Roma tatili için hazırlan",
        house_tidy_prompt: "evi düzenle",
        ...
        toggle_actions_drawer_button_label: "İşlem Çekmecesini Aç/Kapat",
