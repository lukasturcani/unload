...
fn Task(cx: Scope, task_id: TaskId) -> Element {
    ...
    cx.render(rsx! {
        div {
            draggable: true,
            class: "block w-full p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-700 dark:border-gray-700 dark:hover:bg-gray-700",
            h5 {
