...
pub struct Translation {
    ...
    cancel_title_update_label: &'static str,
...
pub fn translations() -> Vec<Translation> {
    let mut translations = vec![
        Translation {
            ...
            cancel_title_update_label: "Cancel Title Update",
        ...
        Translation {
            ...
            cancel_title_update_label: "Zrušiť zmenu názvu",
    ...
    pub fn to_json(&self) -> Value {
        json!({
            ...
            "texts": {
                ...
                "task_title_input_label": self.task_title_input_label,
                "edit_task_title_tooltip": self.edit_task_title_tooltip,
                "board_title_update_label": self.board_title_update_label,
                "set_board_title_label": self.set_board_title_label,
